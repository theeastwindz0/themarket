...
import Testimonials from "../BasicComp/Testimonials";
...
const Home = () => {
  ...
  const dataToSend = {
    ...
    para2:
      "Investing your money is as important as earning an income. Prudent investments help secure your life financially by achieving your financial goals for the present and the future. Investing helps you to generate a parallel stream of income, create more wealth, and earn returns to beat inflation.",
    para3:
    ...
    para4:
      "Investing in share market gives you an opportunity to earn potentially higher returns on your investment. Thus, venturing here gives you a chance to compound your money in the long run and accumulate wealth for various life goals.",
    article2: {
      image1: Container__1,
      para1:
